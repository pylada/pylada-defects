### Instructions to install python, pylada and additional preparations before using pylada_defects.py
...
or to install whole code in developers mode
...
12. Put the whole folder /pyspglib in somewhere equivalent
